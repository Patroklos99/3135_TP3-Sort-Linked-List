...
int main(void) {
   ...
   CU_add_test(lectureSuite, "valider_arg_invalide(4, argv)",
               test_arg_invalide_0);
   CU_add_test(lectureSuite, "valider_arg_invalide(4, argv)",
               test_arg_invalide_1);
   CU_add_test(lectureSuite, "valider_fichier_existe(file)",
               test_fichier_existe_0);
   CU_add_test(lectureSuite, "valider_fichier_existe(file)",
               test_fichier_existe_1);
   ...
   CU_add_test(lectureSuite, "trouver_size_fichier(file, stats)",
               test_trouver_size_0);
   CU_add_test(lectureSuite, "trouver_size_fichier(file, stats)",
               test_trouver_size_1);
   CU_add_test(lectureSuite, "trouver_nb_mots(file, stats)",
               test_trouver_nb_mots_0);
   CU_add_test(lectureSuite, "trouver_nb_mots(file, stats)",
               test_trouver_nb_mots_1);
   ...
   CU_add_test(listeSuite,
               "trouver_lettre_frequente((char const**)words, stats)",
               test_trouver_lettre_freq_0);
   CU_add_test(listeSuite, "placer_mots_tab(file, words)",
               test_placer_mots_tab_0);
   CU_add_test(listeSuite, "effacer_doublons(&val, words)",
               test_effacer_doublons_0);
   CU_add_test(listeSuite, "lire_lignes(file, words, &nb_mots, stats)",
               test_lire_lignes);
   CU_add_test(listechaineeSuite, "init_liste()", test_init_liste);
   CU_add_test(listechaineeSuite,
               "iterer_tab_mots(nb_mots, words, liste->first)",
               test_iter_tab_mots);
   CU_add_test(listechaineeSuite, "init_noeud(words, nb_mots, stats, liste)",
               test_init_noeud_0);
   CU_add_test(listechaineeSuite, "init_noeud(words, nb_mots, stats, liste)",
               test_init_noeud_1);
   CU_add_test(listechaineeSuite, "int compter_lettres(struct noeud *ptr)",
               test_compter_lettres_0);
   CU_add_test(listechaineeSuite, "int compter_lettres(struct noeud *ptr)",
               test_compter_lettres_1);
